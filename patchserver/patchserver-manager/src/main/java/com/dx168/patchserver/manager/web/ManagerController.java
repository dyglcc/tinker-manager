...
public class ManagerController {
    ...
    @RequestMapping(value = "/patch/delClient", method = RequestMethod.GET)
    public ModelAndView delteClient(HttpServletRequest req, Integer id, Integer patchId, String appUid) {
        ...
        return new ModelAndView("redirect:/patch?appUid=" + appUid + "&id=" + patchId);
    }

    @RequestMapping(value = "/patch/addSingleClient", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/patch/importClientFile", method = RequestMethod.POST)
